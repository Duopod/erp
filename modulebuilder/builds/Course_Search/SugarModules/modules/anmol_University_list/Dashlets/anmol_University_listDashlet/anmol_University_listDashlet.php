...
require_once('modules/anmol_University_list/anmol_University_list.php');

class anmol_University_listDashlet extends DashletGeneric
{
    function anmol_University_listDashlet($id, $def = null)
    {
        ...
        if (empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'anmol_University_list');
