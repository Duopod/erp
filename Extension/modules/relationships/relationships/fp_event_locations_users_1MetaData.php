...
$dictionary["fp_event_locations_users_1"] = array(
    ...
    'table' => 'fp_event_locations_users_1_c',
    'fields' =>
        array(
            0 =>
                array(
            ...
            4 =>
                array(
                    'name' => 'fp_event_locations_users_1users_idb',
                    'type' => 'varchar',
                    'len' => 36,
                ),
        ),
    'indices' =>
        array(
            0 =>
                array(
                    'name' => 'fp_event_locations_users_1spk',
                    'type' => 'primary',
                    'fields' =>
                        array(
                            0 => 'id',
            ...
            1 =>
                array(
                    'name' => 'fp_event_locations_users_1_ida1',
                    'type' => 'index',
                    'fields' =>
                        array(
                            0 => 'fp_event_locations_users_1fp_event_locations_ida',
                        ),
                ),
            2 =>
                array(
                    'name' => 'fp_event_locations_users_1_alt',
                    'type' => 'alternate_key',
                    'fields' =>
                        array(
                            0 => 'fp_event_locations_users_1users_idb',
                        ),
                ),
        ),
);