            ...
            <td valign="top" style="padding: 15px 10px 15px 10px;">
                ...
                <div class="about_suite">
                    ...
                    <ul id="about_menu">
                        ...
                        <li><?php echo $mod_strings['LBL_CONTRIBUTOR_QUICKCRM']; ?> (<a
                                href="http://www.quickcrm.fr/mobile" target="_blank">http://www.quickcrm.fr/mobile</a>)
                        </li>
                        ...
                        <li><?php echo $mod_strings['LBL_LANGUAGE_RUSSIAN']; ?> (<a href="mailto:likhobory@mail.ru"
                                                                                    target="_blank">likhobory@mail.ru</a>)
                        </li>
                        <li><?php echo $mod_strings['LBL_SOURCE_SUGAR']; ?> (<a
                                href="index.php?module=Home&action=AboutSugar"><?php echo $mod_strings['LBL_ABOUT']; ?></a>)
                        </li>
                    </ul>
                </div>
                <div class="about_suite">
                    ...
                    <ul id="about_menu">
                        <li><?php echo $mod_strings['LBL_SUITE_PARTNERS']; ?> (<a
                                href="http://suitecrm.com/index.php/suitecrm-partners">http://suitecrm.com</a>)
                        </li>
                    </ul>
                </div>
        </tr>
