...
// created: 2015-12-16 11:55:49
$dictionary["anmol_Applications"]["fields"]["fp_event_locations_anmol_applications_1"] = array(
    'name' => 'fp_event_locations_anmol_applications_1',
    'type' => 'link',
    'relationship' => 'fp_event_locations_anmol_applications_1',
    'source' => 'non-db',
    'module' => 'FP_Event_Locations',
    'bean_name' => 'FP_Event_Locations',
    'vname' => 'LBL_FP_EVENT_LOCATIONS_ANMOL_APPLICATIONS_1_FROM_FP_EVENT_LOCATIONS_TITLE',
    'id_name' => 'fp_event_locations_anmol_applications_1fp_event_locations_ida',
);
$dictionary["anmol_Applications"]["fields"]["fp_event_locations_anmol_applications_1_name"] = array(
    ...
    'save' => true,
    'id_name' => 'fp_event_locations_anmol_applications_1fp_event_locations_ida',
    'link' => 'fp_event_locations_anmol_applications_1',
    'table' => 'fp_event_locations',
    'module' => 'FP_Event_Locations',
    'rname' => 'name',
);
$dictionary["anmol_Applications"]["fields"]["fp_event_locations_anmol_applications_1fp_event_locations_ida"] = array(
    'name' => 'fp_event_locations_anmol_applications_1fp_event_locations_ida',
    'type' => 'link',
    'relationship' => 'fp_event_locations_anmol_applications_1',
    'source' => 'non-db',
    'reportable' => false,
    'side' => 'right',
    'vname' => 'LBL_FP_EVENT_LOCATIONS_ANMOL_APPLICATIONS_1_FROM_ANMOL_APPLICATIONS_TITLE',
);
