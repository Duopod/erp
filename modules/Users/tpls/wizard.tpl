...
<form id="UserWizard" name="UserWizard" enctype='multipart/form-data' method="POST" action="index.php"
      onkeypress="return disableReturnSubmission(event);">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td scope="row">
                                ...
                                <div class="userWizWelcome"><img src='include/images/sugar_wizard_welcome.jpg'
                                                                 border='0' alt='{$MOD.LBL_WIZARD_WELCOME_TAB}'
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <th align="left" scope="row" colspan="4">
                                <h2>
                                    <slot>{$MOD.LBL_WIZARD_PERSONALINFO}</slot>
                                </h2>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_FIRST_NAME}:</slot>
                            </td>
                            <td width="33%">
                                <slot><input id='first_name' name='first_name' tabindex='1' size='25' maxlength='25'
                                             type="text" value="{$FIRST_NAME}"></slot>
                            </td>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_LAST_NAME}: <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
                                </slot>
                            </td>
                            <td width="33%">
                                <slot><input id='last_name' name='last_name' tabindex='2' size='25' maxlength='25'
                                             type="text" value="{$LAST_NAME}"></slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="33%">
                                <slot><input name='email1' tabindex='3' size='30' maxlength='100' value='{$EMAIL1}'
                                             id='email1'/></slot>
                            </td>
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_OFFICE_PHONE}:</slot>
                            </td>
                            <td width="33%">
                                <slot><input name='phone_work' type="text" tabindex='4' size='20' maxlength='25'
                                             value='{$PHONE_WORK}'></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_MESSENGER_TYPE}:</slot>
                            </td>
                            <td>
                                <slot>{$MESSENGER_TYPE_OPTIONS}</slot>
                            </td>
                        </tr>
                        <tr>
                            <td scope="row">
                                <slot>{$MOD.LBL_MOBILE_PHONE}:</slot>
                            </td>
                            <td>
                                <slot><input name='phone_mobile' type="text" tabindex='6' size='20' maxlength='25'
                                             value='{$PHONE_MOBILE}'></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_MESSENGER_ID}:</slot>
                            </td>
                            <td>
                                <slot><input name='messenger_id' type="text" tabindex='6' size='30' maxlength='100'
                                             value='{$MESSENGER_ID}'></slot>
                            </td>
                        </tr>
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_PRIMARY_ADDRESS}:</slot>
                            </td>
                            <td width="33%">
                                <slot><textarea name='address_street' rows="2" tabindex='8'
                                                cols="30">{$ADDRESS_STREET}</textarea></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>&nbsp;</slot>
                            </td>
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_CITY}:</slot>
                            </td>
                            <td width="33%">
                                <slot><input name='address_city' tabindex='8' size='15' maxlength='100'
                                             value='{$ADDRESS_CITY}'></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_STATE}:</slot>
                            </td>
                            <td>
                                <slot><input name='address_state' tabindex='9' size='15' maxlength='100'
                                             value='{$ADDRESS_STATE}'></slot>
                            </td>
                        </tr>
                        <tr>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_POSTAL_CODE}:</slot>
                            </td>
                            <td>
                                <slot><input name='address_postalcode' tabindex='9' size='10' maxlength='20'
                                             value='{$ADDRESS_POSTALCODE}'></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_COUNTRY}:</slot>
                            </td>
                            <td>
                                <slot><input name='address_country' tabindex='10' size='10' maxlength='20'
                                             value='{$ADDRESS_COUNTRY}'></slot>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <th width="100%" align="left" scope="row" colspan="4">
                                <h2>
                                    <slot>{$MOD.LBL_WIZARD_LOCALE}</slot>
                                </h2>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_TIMEZONE}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_TIMEZONE_TEXT }</td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_DATE_FORMAT}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_DATE_FORMAT_TEXT }</td>
                            <td width="33%">
                                <slot><select tabindex='14' name='dateformat'>{$DATEOPTIONS}</select></slot>
                            </td>
                            <td scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_TIME_FORMAT}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_TIME_FORMAT_TEXT }</td>
                            <td>
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_CURRENCY}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_CURRENCY_TEXT }</td>
                            <td>
                                <slot>
                        ...
                        <tr>
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_DECIMAL_SEP}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_DECIMAL_SEP_TEXT }</td>
                            <td>
                                <slot>
                            ...
                            <td width="17%" scope="row" nowrap="nowrap">
                                <slot>{$MOD.LBL_NUMBER_GROUPING_SEP}:</slot>
                                &nbsp;{sugar_help text=$MOD.LBL_NUMBER_GROUPING_SEP_TEXT }</td>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap" scope="row" valign="top">{$MOD.LBL_LOCALE_DEFAULT_NAME_FORMAT}
                                :&nbsp;{sugar_help text=$smarty.capture.SMARTY_LOCALE_NAME_FORMAT_DESC }</td>
                            <td>
                                <slot><select id="default_locale_name_format" tabindex='14'
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td width="20%" scope="row"><span
                                            id="mail_smtpserver_label">{$MOD.LBL_EMAIL_PROVIDER}</span></td>
                                <td width="30%">
                                    <slot>{$mail_smtpdisplay}<input id='mail_smtpserver' name='mail_smtpserver'
                                                                    type="hidden" value='{$mail_smtpserver}'/></slot>
                                </td>
                                <td scope="row">&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            {if !empty($mail_smtpauth_req)}
                                <tr>
                                    ...
                                    <td width="30%">
                                        <slot><input type="text" id="mail_smtpuser" name="mail_smtpuser" size="25"
                                                     maxlength="64" value="{$mail_smtpuser}" tabindex='1'></slot>
                                    </td>
                                    <td scope="row">&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="30%">
                                        <slot><input type="password" id="mail_smtppass" name="mail_smtppass" size="25"
                                                     maxlength="64" value="{$mail_smtppass}" tabindex='1'></slot>
                                    </td>
                                    <td scope="row">&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td scope="row">
                                ...
                                <table cellpadding=0 cellspacing=0><input id='whatnext' name='whatnext' type="hidden"
                                                                          value='finish'/>
                                    {if $IS_ADMIN}
                                        <tr>
                                            <td><img src=include/images/start.png style="margin-right: 5px;"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src=include/images/import.png style="margin-right: 5px;"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src=include/images/create_users.png style="margin-right: 5px;">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src=include/images/settings.png style="margin-right: 5px;"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src=include/images/configure.png style="margin-right: 5px;"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src=include/images/university.png style="margin-right: 5px;"></td>
                                            <td><a href="http://www.suitecrm.com/forum/index"
                                    ...
                                    {else}
                                        <tr>
                                            <td><img src=include/images/university2.png style="margin-right: 5px;"></td>
                                            <td><a href="http://www.suitecrm.com/forum/index"
                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH11} </b></a></b>
                                                <br>{$MOD.LBL_WIZARD_FINISH12}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><img src=include/images/docs.png style="margin-right: 5px;"></td>
                                            <td><a href="http://suitecrm.com/suitecrm-the-sugarcrm-fork"
                                        ...
                                        <tr>
                                            <td><img src=include/images/kb.png style="margin-right: 5px;"></td>
                                            <td><a href="http://suitecrm.com/suitecrm-the-sugarcrm-fork"
                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH16} </b></a></b>
                                                <br>{$MOD.LBL_WIZARD_FINISH17}</td>
                                        </tr>
                                        <tr>
                                            <td colspan=2>
                                                <hr style="margin: 5px 0px;">
                                        ...
                                        <tr>
                                            <td><img src=include/images/forums.png style="margin-right: 5px;"></td>
                                            <td><a href="http://www.suitecrm.com/forum/index"
