...
$dictionary['securitygroups_records'] = array(
    ...
    'indices' => array(
        array('name' => 'securitygroups_recordspk',
            'type' => 'primary',
            'fields' => array('id')),
        array('name' => 'idx_securitygroups_records_mod',
            'type' => 'index',
            'fields' => array('module',
                'deleted',
                'record_id',
                'securitygroup_id')),
        array('name' => 'idx_securitygroups_records_del',
            'type' => 'index',
