...
,
    'fields' => array(
        array('name' => 'id',
            ...
            'len' => '36')
    ,
        array('name' => 'aow_processed_id',
            'type' => 'varchar',
            'len' => '36')
    ,
        array('name' => 'aow_action_id',
            'type' => 'varchar',
            'len' => '36')
    ,
        array('name' => 'status',
    ...
    'indices' => array(
        array('name' => 'aow_processed_aow_actionsspk',
            'type' => 'primary',
            'fields' => array('id'))
    ,
        array('name' => 'idx_aow_processed_aow_actions',
            'type' => 'alternate_key',
            'fields' => array('aow_processed_id',
                'aow_action_id'))
    ,
        array('name' => 'idx_actid_del_freid',
            'type' => 'index',
            'fields' => array('aow_action_id',
                'deleted',
                'aow_processed_id'))
...
,
    'relationships' => array('aow_processed_aow_actions' => array('lhs_module' => 'AOW_Processed',
